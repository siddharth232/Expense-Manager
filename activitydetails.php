...
<body>
    ...
    <div id="db"><table><tr class="dbc"><td><a href="home.php">Dashboard</a></td></tr>
                        <tr class="dbc"><td><a href="addgrpexpense.php">Add Group Expense </a></td></tr>
    ...
    <div id="cont">
      <table>
        ...
        <?php 
         ...
         // $title=$_GET['title'];
          $title='dinner';
          $sql="SELECT * from groupactivity WHERE created='$username' AND groupname='$groupname' AND title='$title' AND fname='$username' ";
     ...
     // <button id='update'><a href='update.php?md=$id'>Update</a></button> ";
             ...
             $sql="SELECT * from groupactivity WHERE created='$username' AND groupname='$groupname' AND title='$title'"; 
             $result=$conn->query($sql);
             while ($row=$result->fetch_assoc()) {
              $fname=$row['fname'];
              $paid=$row['pm'];
              $owes=$row['am'];
              echo "<h2>$fname paid Rs.$paid and owes Rs.$owes</h2>";
             }
          }
          else
          {
