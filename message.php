        ...
        <?php 
          ...
          if ($result->num_rows>0) {
            while ($row=$result->fetch_assoc()) {
              $message=$row['message'];
              $time=$row['time'];
            echo "<tr><td class='acte'><a>$message&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp$time</a></td>
               </tr>";
            }
          }
          else
          {
            echo" <tr><td class= 'acte'>No Notifications !!!</td>
               </tr>";
          }
          ?>
      </table>
